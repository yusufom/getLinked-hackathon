...
const TimelineItem = ({ date, title, number, isEven, description }) => {
    return (
        <div className={`flex ${isEven ? 'flex-row-reverse' : 'flex-row'} mt-6 mb-6 justify-center gap-x-[90px] items-center`}>
            ...
            <div className='relative'>
                <div class="absolute border-primary h-20 border -top-24 left-1/2 -z-40"></div>
...
function Timeline() {
    ...
    return (
        <section name='/#Timeline' id='Timeline' className='relative'>
            ...
            <div className='max-w-[1512px] mx-auto px-[128px] mt-[72px] mb-[110px]'>
                <div className='text-center'>
                    <h2 className='font-Clash text-[32px] font-bold'>Timeline</h2>
                    <p className='text-sm max-w-[346px] mx-auto mt-3'>Here is the breakdown of the time we anticipate
